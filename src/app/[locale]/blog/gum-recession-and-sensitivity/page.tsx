import {
  ...
  import GumRecessionAndSensitivity from "@/components/PageContent/GumRecessionAndSensitivity";
  ...
  const GumRecessionAndSensitivityBlogPage = () => {
  ...
  export default GumRecessionAndSensitivityBlogPage;
