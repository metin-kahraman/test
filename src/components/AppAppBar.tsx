...
const languages = [
  { code: "en", flagUrl: "https://flagcdn.com/w320/gb.png" }, // İngilizce için bayrak
  { code: "tr", flagUrl: "https://flagcdn.com/w320/tr.png" }, // Türkçe için bayrak
  { code: "ru", flagUrl: "https://flagcdn.com/w320/ru.png" }, // Rusça için bayrak
  { code: "fr", flagUrl: "https://flagcdn.com/w320/fr.png" }, // Fransızca için bayrak
];
    ...
    >
      <Container maxWidth="lg">
        <StyledToolbar variant="dense" disableGutters>
          ...
          >
            <IconButton aria-label="phone" size="small" color="warning">
              <PhoneIcon />
            </IconButton>
            ...
            <CustomSelect
              ...
              renderValue={(selected) => (
                ...
                >
                  <img
                    src={
                      languages.find((lang) => lang.code === selected)
                        ?.flagUrl || languages[0].flagUrl
                    }
                    alt={selected}
                    style={{
                      width: 24,
  ...
  {languages.map((lang) => (
    <IconButton
      ...
      sx={{ 
        ...
        alignItems: 'center', 
        justifyContent: 'center',
        mt: 2, // Her bir IconButton arasında boşluk bırakmak için
        border:2,borderBlockColor:'orange'
      }}
      aria-label="flag"
      size="small"
      color="success"
